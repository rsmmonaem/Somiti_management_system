...
?>
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0 text-uppercase">ব্যয় </h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-5">
                        <div class="text-center">
                            <h5><?= $setting->setting_title?></h5>
                            <p><?= $setting->setting_tagline?></p>
                            <h6><?= $setting->setting_location?></h6>
                            <h6><?= $setting->setting_phone?></h6>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="staticEmail" value="0 <?= $data->expense_id?>" readonly disabled>
                            </div>
                        </div>
                        <div class="mb-1 row">
                            <label for="staticEmail" class="col-sm-3 col-form-label">ব্যয়ঃ</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="staticEmail" value="<?=$data->expense_date?>" readonly disabled>
                            </div>
                        </div>
                        <div class="mb-1 row">
                ...
                <div class="row mt-5">
                    <hr>
                    <h2 class="text-center">ব্যয়ের রশিদ
                    </h2>
                    <hr>
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">ব্যায়ের ধরনঃ</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="staticEmail" value="<?= $data->expense_type ?>" readonly disabled>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">ব্যয়ের পরিমাণঃ</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="staticEmail" value="<?= $data->expense_amount ?>" readonly disabled>
                        </div>
                    </div>
