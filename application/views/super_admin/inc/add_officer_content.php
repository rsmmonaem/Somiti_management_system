        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>super_admin/officer_list" class="btn btn-primary"><i class="bx bx-arrow-back"></i> অফিসার লিস্ট দেখুন </a>

                </div>
            </div>
            <div class="card-body p-4">

                <form action="<?= base_url();?>super_admin/save_officer" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="officer_type" class="form-select" id="inputVendor"  required="required">
                                        ...
                                        <option value="branch_manager">Branch Manager</option>                                    </select>
                                </div>
                            </div>
