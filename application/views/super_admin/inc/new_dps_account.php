    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title">নতুন ডিপিএস একাউন্ট খুলুন
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>account_admin/dps_account_list" class="btn btn-primary"><i class="bx bx-arrow-back"></i>ডিপিএস একাউন্ট লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">

                <form action="<?= base_url();?>account_admin/save_dps_account" method="post" enctype="multipart/form-data">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#single-select-field-a').change(function() {
                    ...
                    $.ajax({
                        url: '<?= base_url()?>account_admin/get_dps_plan_amount', // Update with your controller method URL
                        type: 'POST',
