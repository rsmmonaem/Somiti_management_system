    ...
    <div class="page-content">
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/save_loans" method="post" enctype="multipart/form-data">
                    <div class="form-body mt-4">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label for="single-select-field" class="form-label">সদস্য নির্বাচন করুন </label>
                                    <select name="loans_member_id" class="form-select" id="single-select-field" data-placeholder="সদস্য নির্বাচন করুন" required="required">
                                        <option></option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="single-select-field-b" data-placeholder="জামিনদার নির্বাচন করুন" name="loans_guarantor_id" required="required">
                                        <option></option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="loans_amount" class="form-control" id="main_amount" placeholder="Example: 100000" required="required">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="loans_installment_collection_type" class="form-select" id="installment_data_wise" required="required">
