        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>super_admin/guarantor_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i>  জামিনদার লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>super_admin/update_guarantor/<?= $data->guarantor_id ?> ?>" method="post" enctype="multipart/form-data">
