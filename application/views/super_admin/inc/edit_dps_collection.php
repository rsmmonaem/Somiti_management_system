        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>account_admin/dps_collection_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> ডিপিএস কালেকশন লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">

                <form action="<?= base_url();?>account_admin/update_dps_collection/<?= $data->dps_col_id?>" method="post" enctype="multipart/form-data">
