        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/salary_list" class="btn btn-primary">
                        <i class="bx bx-arrow-back"></i> বেতন লিস্ট দেখুন </a>
                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/save_salary" method="post" enctype="multipart/form-data">
