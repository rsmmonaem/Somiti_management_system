...
<div class="page-wrapper">
    <div class="page-content">
        ...
        $this->db->where("loans_branch_id", $user_id);
        ...
        $user_id = $this->session->userdata('user_id');
        $this->db->where("sa_branch_id", $user_id);
        ...
        $user_id = $this->session->userdata('user_id');
        $this->db->where("dps_acc_branch_id", $user_id);
        ...
        //============ FDR Account ================
        $user_id = $this->session->userdata('user_id');
        $this->db->where("fdr_branch_id", $user_id);
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        $user_id = $this->session->userdata('user_id');
                        foreach ($this->alm->get_member_loans_collections_branch($user_id) as $row):?>
                        <tr>
                            <td><?= $row->loans_id ?></td>
