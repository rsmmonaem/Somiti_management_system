        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/assets_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> সম্পত্তি লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/update_assets/<?= $data->assets_id?>" method="post" enctype="multipart/form-data">
