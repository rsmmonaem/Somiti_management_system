        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/daily_saving_collection_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> সঞ্চয় সংগ্রহ লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/update_saving_collection/<?=$data->dsc_id?>" method="post" enctype="multipart/form-data">
