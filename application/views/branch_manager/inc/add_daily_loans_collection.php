        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/daily_loan_collection_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> ঋণ সংগ্রহ </a>

                </div>
            </div>
            <div class="card-body">

                <form action="<?= base_url() . (isset($loan_product) ? 'branch_manager/update_daily_loan' : 'branch_manager/save_daily_loan') ?>" method="post" enctype="multipart/form-data">
