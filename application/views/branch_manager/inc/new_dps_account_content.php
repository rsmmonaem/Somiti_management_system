<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="<?= base_url()?>branch_manager/dps_plan" class="btn btn-primary"><i class="bx bx-plus-circle"></i> ডিপিএস প্লান  </a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <hr>
                                <a href="<?= base_url(); ?>branch_manager/new_dps_account" class="btn btn-primary">Choose Plan </a>
                            </div>
