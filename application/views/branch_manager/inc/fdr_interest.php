<div class="page-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="<?= base_url()?>branch_manager/fdr_account" class="btn btn-primary"><i class="bx bx-plus-circle"></i>এফডিআর ইন্টারেস্ট একাউন্ট </a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                ...
                <div class="table-responsive">
                    ...
                    <table id="example" class="table table-striped table-bordered table-responsive" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td><a href="<?= base_url()?>branch_manager/interest_generate/<?= $row->fdr_id?>" class="btn btn-success"><i class="lni lni-revenue"></i> Interest</a></td>
                        </tr>
                        <?php endforeach;?>
                        </tbody>
                    </table>
