        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/dps_plan_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i>  ডিপিএস প্লান লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <hr/>
                <form action="<?= base_url()?>branch_manager/update_dps_plan" method="post" enctype="multipart/form-data">
