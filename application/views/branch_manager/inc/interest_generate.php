<div class="page-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="<?= base_url()?>branch_manager/fdr_interest" class="btn btn-primary"><i class="bx bx-arrow-back"></i>এফ ডি আর ইন্টারেস্ট </a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr/>
                <form action="<?= base_url();?>branch_manager/save_interest_generate" method="post" enctype="multipart/form-data">
