    ...
    <div class="page-content">
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/save_update_profile" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="user_type" id="" class="form-select" >
                                    <option value="branch_manager" <?php if ($user_info->user_type == "branch_manager"){echo "selected";}?>>Branch Manager</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
