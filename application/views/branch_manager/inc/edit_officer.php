    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr/>
                <form action="<?= base_url();?>branch_manager/update_officer/" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="officer_type" class="form-select" id="inputVendor">
                                        <option>Select</option>
										<option value="branch_manager" <?php if ($data->officer_type == 'branch_manager'){echo 'selected';}?>>Field Worker</option>
                                        <option value="manager" <?php if ($data->officer_type == 'manager'){echo 'selected';}?>>Manager</option>
                                    </select>
                                </div>
                            </div>
