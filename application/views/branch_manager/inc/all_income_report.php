        ...
        <div class="row">   
            ...
            <div id="printable-content" class="card">
				...
				<div class="col-md-12" style="text-align: center;display: flex;justify-content: center;margin-bottom: 40px; margin-top: 50px;">
					<h4 style="float: left;">সকল আয় সংক্রান্ত রিপোর্ট &nbsp;&nbsp;<?=$endDate?> &nbsp; TO &nbsp; <?=$endDate?></h4>
    			</div>
                </div>
				...
				<?php echo $row->income_name ?>
								</td>
                                <td>
								<?php echo $row->income_type ?>
								</td>
                                <td id="am">
                                ...
                                <td id="ax" ><?= $row->income_amount?></td>
								<td><?= $row->income_date?></td>
                            </tr>
                            <?php endforeach;?>
							<tr>

								<td colspan="4"> ‍মোট আয় =</td>
