        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/loan_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> ঋণ একাউন্ট  লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/update_loans" method="post" enctype="multipart/form-data">
