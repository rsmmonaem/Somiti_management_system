<div class="page-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">নতুন ইনভেস্ট</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>branch_manager/invest_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> ইনভেস্ট লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>branch_manager/save_invest" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row border border-1">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="invest_type" class="form-control" id="name" placeholder="ইনভেস্ট ধরন">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">ইনভেস্টের পরিমাণ <label class="text-danger"> *</label></label>
                                    <input type="number" name="invest_amount" class="form-control" id="amount" placeholder="১০০০">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="" class="form-label">তারিখ</label>
                                    <input type="date" name="invest_date" class="form-control" id="name" placeholder="ইনভেস্ট তারিখ">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="invest_person_name" class="form-control" id="name" placeholder="রহিম মিয়া">
                                </div>
                            </div>
							...
							<div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="invest_person_id" class="form-control" id="name" placeholder="088******">
                                </div>
                            </div>
							...
							<div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="invest_person_number" class="form-control" id="name" placeholder="01*******">
                                </div>
                            </div>
							...
							<div class="col-md-6">
                                <div class="mb-3">
									...
									<textarea name="invest_person_address" id="" class="form-control" cols="2" rows="2"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="phone" class="form-label">ইনভেস্টের বর্ণনা </label>
                                    <textarea name="invest_description" id="" class="form-control" cols="2" rows="2"></textarea>
                                </div>
                            </div>
