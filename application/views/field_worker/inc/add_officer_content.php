        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>field_worker/officer_list" class="btn btn-primary"><i class="bx bx-arrow-back"></i> অফিসার লিস্ট দেখুন </a>

                </div>
            </div>
            <div class="card-body p-4">

                <form action="<?= base_url();?>field_worker/save_officer" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row border border-1">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="officer_name" class="form-control" id="name" placeholder="Example: Durjay Ghosh">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="officer_father_name" class="form-control" id="name" placeholder="Father Name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">মাতার নাম <label class="text-danger"> *</label></label>
                                    <input type="text" name="officer_mother_name" class="form-control" id="business" placeholder="Mother Name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">জন্ম তারিখ <label class="text-danger"> *</label></label>
                                    <input type="date" name="officer_dob" class="form-control" id="inputProductTitle">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">এন আই ডি নাম্বার / জন্ম নিবন্ধন নাম্বার  <label class="text-danger"> *</label></label>
                                    <input type="number" name="officer_nid" class="form-control" id="number" placeholder="NID or Birth Registration Number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="officer_email" class="form-control" id="inputProductTitle" placeholder="Emaill Address">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="phone" class="form-label">মোবাইল নাম্বার<label class="text-danger"> *</label></label>
                                    <input type="tel" name="officer_phone" class="form-control" id="phone" placeholder="017XXXXXXXXX2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="officer_address" class="form-control" id="address" placeholder="Majhira, Shajahanpur, Bogura">
                                </div>
                            </div>
