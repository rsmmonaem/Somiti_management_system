...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="<?= base_url()?>field_worker/add_officer" class="btn btn-primary"><i class="bx bx-plus-circle"></i> অফিসার যোগ করুন </a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <a href="<?= base_url()?>field_worker/edit_officer/<?= $data->officer_id?>" class="btn btn-warning "> এডিট করুন</a>
                                        <a href="<?= base_url()?>field_worker/add_officer/" class="btn btn-primary">নতুন যোগ করুন</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <a href="<?= base_url()?>field_worker/edit_officer/<?= $data->officer_id?>" class="btn btn-warning px-4"> এডিট করুন</a>
                                    </div>
                                </div>
                            </div>
                        </div>
