        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>field_worker/income_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> আয় লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>field_worker/update_income/<?= $data->income_id?>" method="post" enctype="multipart/form-data">
