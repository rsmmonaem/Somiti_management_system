        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>field_worker/daily_saving_collection_list" class="btn btn-primary"><i class="bx bx-left-arrow"></i> সঞ্চয় সংগ্রহ লিস্ট </a>

                </div>
            </div>
            <div class="card-body p-4">
                <form action="<?= base_url();?>field_worker/save_saving_collection" method="post" enctype="multipart/form-data">
                    <div class="form-body mt-4">
                        <div class="row border border-1">
                            ...
                            <input type="hidden" name="dsc_branch_id" id="sa_id_branch" value="">
