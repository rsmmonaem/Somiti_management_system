        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <a href="<?= base_url()?>field_worker/scheme_list" class="btn btn-primary"><i class="bx bx-arrow-back"></i> স্কিম লিস্ট </a>
            ...
            <div class="card-body p-4">
                ...
                <form action="<?= (!isset($plane) ? base_url() . 'field_worker/save_saving_plan' : base_url() . 'field_worker/update_saving_plan') ?>" method="post" enctype="multipart/form-data">
                    <?php
					if (isset($plane)) {
