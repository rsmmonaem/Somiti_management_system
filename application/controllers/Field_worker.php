...
class field_worker extends CI_Controller {
    ...
    public function index() {
        ...
        if (!$this->session->userdata('user_name')) {
            ...
            $this->session_data();
            $data['title'] = "";
            $this->load->view('field_worker/index',$data);
        }
    }

    public function update_profile(){
        $data['title']= "প্রোফাইল আপডেট করুন";
        $this->load->view('field_worker/update_profile',$data);
    }
    ...
    public function save_update_profile(){
        ...
        redirect("field_worker/update_profile");
    }
    ...
    public function add_member(){
        ...
        $this->load->view('field_worker/add_member',$data);
    }
    ...
    public function save_member(){
        ...
        redirect("field_worker/add_member");
    }
    public function member_list() {
        $this->session_data();
        $this->load->model('add_member_model', 'amm');
        $user_id = $this->session->userdata('user_id');
        $data['data'] = $this->amm->get_member_worker($user_id);
        $data['title'] = "সদস্যের লিস্ট";
        $this->load->view('field_worker/member_list', $data);
    }
    public function edit_member($id) {
        ...
        $this->load->model('add_officer_model', 'aom');
        $data['officer'] = $this->aom->get_officer();
        $this->load->view('field_worker/edit_member', $data);
    ...
    public function update_member() {
        ...
        redirect("field_worker/member_list");
    }
    ...
    public function member_profile($id) {
        ...
        $this->load->view('field_worker/member_profile', $data);
    }
    ...
    public function search_member(){
        ...
        $this->load->view('field_worker/search_member', $data);
    }
    ...
    public function save_loans(){
        ...
        redirect("field_worker/add_loans");
    }
    public function loans_list(){
        ...
        $user_id = $this->session->userdata('user_id');
        $data['loans_list'] = $this->alm->get_loans_worker($user_id);

        $this->load->view("field_worker/loans_list", $data);
    }
    ...
    public function edit_loans($id) {
        ...
        $this->load->view('field_worker/edit_loan', $data);
    }
    ...
    public function update_loans(){
        ...
        redirect("field_worker/loans_list");
    }
    ...
    public function add_loan_products(){
        ...
        $this->load->view('field_worker/add_loan_products', $data);
    }
    ...
    public function save_loan_products(){
        ...
        redirect("field_worker/add_loan_products");
    }
    ...
    public function add_guarantor(){
        ...
        $this->load->view('field_worker/add_guarantor', $data);
    }
    public function edit_guarantor($id){
        ...
        $this->load->view('field_worker/edit_guarantor', $data);
    }
    ...
    public function update_guarantor(){
        ...
        $_SESSION['success'] = 'Updated successfully.';
        redirect("field_worker/guarantor_list");
    }
    ...
    public function save_guarantor(){
        ...
        redirect("field_worker/add_guarantor");
    }
    public function guarantor_list(){
        ...
        $this->load->view('field_worker/guarantor_list', $data);
    }
    ...
    function delete_guarantor($guarantor_id) {
        ...
        redirect("field_worker/daily_loan_collection_list");
    }
    // End Guarantor
//
//
...
//
//        $this->load->view('field_worker/loan_collection', $data);
//    }
...
//
//        $this->load->view('field_worker/loan_collection_report', $data);
//    }
//
//
...
//
//        $this->load->view('field_worker/saving_collection', $data);
//    }
...
//
//        $this->load->view('field_worker/saving_collection_report', $data);
//    }
//
//
...
//			$this->load->view('field_worker/all_fdr', $data);
//		}
...
//			$this->load->view('field_worker/fdr_report', $data);
//		}
//
//
//	// REPORT Expense
...
//        $this->session_data();
//        $data['title'] = "সকল খরচ";
//    $this->load->view('field_worker/all_expense', $data);
//    }
...
//        $this->load->view('field_worker/all_expense_report', $data);
//    }
//
//	// REPORT Income
...
//        $this->session_data();
//        $data['title'] = "সকল আয়";
//    $this->load->view('field_worker/all_income', $data);
//    }
//
...
//        $this->load->view('field_worker/all_income_report', $data);
//    }
//
//		// REPORT Salary
...
//			$this->session_data();
//			$data['title'] = "সকল বেতন";
//			$this->load->view('field_worker/all_salary', $data);
//		}
//
...
//			$this->load->view('field_worker/all_salary_report', $data);
//		}
//
//	// End Date Wise All Reports
    ...
    $this->load->view('field_worker/add_daily_collection', $data);
    }
    ...
    public function daily_loan_report(){
        ...
        // $data['title'] = "ঋণ সংগ্রহের রিপোর্ট";
        // $this->load->view('field_worker/daily_loan_report', $data);
    }
    ...
    public function save_daily_loan(){
        ...
        redirect("field_worker/daily_loan_collection");
    }
	...
	public function daily_loan_collection_list(){
        ...
        $this->load->model('add_loans_model', 'alm');
        $user_id = $this->session->userdata('user_id');
        $data['loan_product'] = $this->alm->get_daily_loan_collect_worker($user_id);
        $data['title'] = "প্রতিদিনের ঋণ জমা রিপোর্ট";
        $this->load->view('field_worker/daily_loan_collection_list', $data);
    }
...
//        $this->load->view('field_worker/add_saving_plan', $data);
//    }
    public function save_saving_plan(){
        ...
        redirect("field_worker/add_saving_plan");
    }
    ...
    public function add_saving_account(){
        ...
        $this->load->view('field_worker/add_saving_account', $data);
    }
    ...
    public function save_account(){
        ...
        redirect("field_worker/add_saving_account");
    }
    public function saving_account_list() {
        ...
        $data['data'] = $this->ssm->get_saving_worker($user_id);
        $data['title'] = 'সঞ্চয় একাউন্ট লিস্ট';
        $this->load->view('field_worker/saving_list', $data);
    }
	...
	public function update_saving_account() {
		...
		$_SESSION['success'] = 'Update successfully.';
		redirect("field_worker/saving_account_list");
    }
...
//        $this->load->view('field_worker/matured_account_list', $data);
//    }
	...
	public function matured_now($sa_id) {
        ...
        redirect("field_worker/matured_account_list");
    }
	...
	public function active_now($sa_id) {
		...
		$this->db->where('sa_id', $sa_id);
        $this->db->update('saving_account', $data);
        redirect("field_worker/active_account_list");
    }
	...
	public function update_saving_plan() {
		...
		$_SESSION['success'] = 'Update successfully.';
		redirect("field_worker/scheme_list");
    }
...
//        $this->load->view('field_worker/add_officer', $data);
//    }
     public function save_officer(){
        ...
        redirect("field_worker/add_officer");
    }
    ...
    public function officer_list(){
        ...
        $this->load->view("field_worker/officer_list", $data);
    }
    public function edit_officer($id) {
        ...
        $data['title'] = "আপডেট করুন";
        $this->load->view('field_worker/edit_officer', $data);
	...
	public function update_officer() {
        ...
        redirect("field_worker/officer_list");
    }
	public function officer_profile($id) {
		...
		$data['data'] = $this->aom->get_officer_id('officer',$id);
        $this->load->view('field_worker/officer_profile', $data);
    }
...
//        $this->load->model('add_officer_model', 'aom');
//        $data['data'] = $this->aom->get_officer();
//        $this->load->view('field_worker/add_salary', $data);
//    }
    ...
    public function save_salary(){
        ...
        redirect("field_worker/add_salary");
    }
	...
	public function salary_list(){
        ...
        $this->load->view('field_worker/salary_list', $data);
    }
    function salary_delete($salary_id) {
        ...
        $_SESSION['success'] = 'Deleted Successfully.';
        redirect("field_worker/salary_list");
    }
 //End Officer Salary
...
//Start saving collection
    public function daily_saving_collection() {
    	...
    	$this->load->view('field_worker/daily_saving_collection', $data);
    }
    ...
    public function edit_ds_collection($id) {
    	...
    	$this->load->view('field_worker/edit_daily_saving_collection', $data);
    }
...
//        $_SESSION['success'] = 'Deleted Successfully.';
//        redirect("field_worker/daily_saving_collection_list");
//    }
    function ds_collection_delete($dsc_id) {
        $this->session_data();
    ...
    public function save_saving_collection(){
        ...
        redirect("field_worker/daily_saving_collection");
    }
      ...
      public function daily_saving_collection_list(){
		...
		$this->load->model('saving_model', 'ssm');
		$user_id = $this->session->userdata('user_id');
        $data['data'] = $this->ssm->get_daily_collection_list_worker($user_id);
        $data['title'] = 'সঞ্চয় জমা করুন';
        $this->load->view("field_worker/daily_saving_collection_list", $data);
    }
...
//        $this->load->view('field_worker/add_assets', $data);
//    }
...
//        $this->load->view('field_worker/assets_list', $data);
//    }
//
...
//        $data['title'] = "আপডেট করুন";
//        $this->load->view('field_worker/edit_assets', $data);
//    }
//
...
//        $_SESSION['success'] = 'Updated Successfully.';
//        redirect("field_worker/assets_list");
//    }
...
//        $this->load->view('field_worker/add_expense', $data);
//    }
...
//        redirect("field_worker/add_expense");
//    }
//
...
//        $this->load->view('field_worker/expense_list', $data);
//    }
//
...
//        $data['title'] = "আপডেট করুন";
//        $this->load->view('field_worker/edit_expense', $data);
//    }
...
//        $this->load->view('field_worker/expense_print', $data);
//    }
//
...
//        $_SESSION['success'] = 'Updated Successfully.';
//        redirect("field_worker/expense_list");
//    }
...
//        $this->load->view('field_worker/add_income', $data);
//    }
...
//        redirect("field_worker/add_income");
//    }
//
...
//        $this->load->view('field_worker/income_list', $data);
//    }
//
...
//        $data['title'] = "আপডেট করুন";
//        $this->load->view('field_worker/edit_income', $data);
//    }
...
//        $data['data'] = $this->sim->get_income_id('income',$id);
//        $data['title'] = "প্রিন্ট করুন";
//        $this->load->view('field_worker/income_print', $data);
//    }
//
...
//        $_SESSION['success'] = 'Updated Successfully.';
//        redirect("field_worker/income_list");
//    }
...
//        $this->load->view('field_worker/add_invest', $data);
//    }
...
//        redirect("field_worker/add_invest");
//    }
//
...
//        $this->load->view('field_worker/invest_list', $data);
//    }
...
//         $_SESSION['success'] = 'Deleted Successfully.';
//         redirect("field_worker/invest_list");
//     }
//
...
//         $data['title'] = "আপডেট করুন";
//         $this->load->view('field_worker/edit_invest', $data);
//     }
//
...
//		//print_r($data);
//        $this->load->view('field_worker/office_wallet', $data);
//    }
//
...
//		$data['title'] = "বেতনের রিপোর্ট";
//		$this->load->view('field_worker/provident_fund_list', $data);
//	}
...
//        $this->load->view('field_worker/scheme_list', $data);
//    }
//
//    public function dps_plan(){
//        $this->session_data();
//        $data['title'] = "ডিপিএস প্লান";
//        $this->load->view('field_worker/dps_plan', $data);
//    }
    public function dps_plan_list(){
        ...
        $this->load->view('field_worker/dps_plan_list', $data);
    }
    ...
    public function edit_dps_plan($id) {
        ...
        $data['title'] = "আপডেট করুন";
        $this->load->view('field_worker/edit_dps_plan', $data);
    }
    ...
    function dps_plan_delete($dps_plan_id) {
        ...
        $_SESSION['success'] = 'Deleted successfully.';
        redirect("field_worker/dps_plan_list");
    }
    ...
    public function dps_account(){
        ...
        $this->load->view('field_worker/dps_account', $data);
    }
    ...
    public function dps_account_list(){
        ...
        $this->load->model('dps_account_model', 'dam');
        $user_id = $this->session->userdata('user_id');
        $data['account'] = $this->dam->get_member_dps_account_worker($user_id);
        $this->load->view('field_worker/dps_account_list', $data);
    }
    ...
    function dps_delete($dps_acc_id) {
        ...
        $_SESSION['success'] = 'Deleted successfully.';
        redirect("field_worker/dps_account_list");
    }
    ...
    public function edit_dps_account($id) {
        ...
        $this->load->model('add_member_model', 'amm');
        $data['member'] = $this->amm->get_member();
        $this->load->view('field_worker/edit_dps_account', $data);
    }
    ...
    public function new_dps_account(){
        ...
        $this->load->model('add_officer_model', 'aom');
        $data['officer'] = $this->aom->get_officer();
        $this->load->view('field_worker/new_dps_account', $data);
    }
    ...
    public function save_dps_account(){
        ...
        redirect("field_worker/new_dps_account");
    }
    ...
    public function save_dps_plan(){
        ...
        redirect("field_worker/dps_plan");
    }
    ...
    public function fdr_account(){
        ...
        $this->load->model('add_officer_model', 'aom');
        $data['officer'] = $this->aom->get_officer();
        $this->load->view('field_worker/fdr_account', $data);
    }
    ...
    public function save_fdr_account(){
        ...
        redirect("field_worker/fdr_account");
    }
    ...
    public function fdr_account_list(){
        ...
        $data['fdrList'] = $this->fam->get_fdr_account_worker($user_id);
        $this->load->view('field_worker/fdr_account_list', $data);
    }
    ...
    public function edit_fdr($id) {
        ...
        $this->load->model('add_member_model', 'amm');
        $data['member'] = $this->amm->get_member();
        $this->load->view('field_worker/edit_fdr', $data);
    ...
    public function update_fdr(){
        ...
        redirect("field_worker/fdr_account_list");
    }
    ...
    public function dps_collection()
    {
        ...
        $this->load->model('add_officer_model', 'aom');
        $data['officer'] = $this->aom->get_officer();
        $this->load->view('field_worker/dps_collection', $data);
    }
    ...
    public function dps_collection_submit() {
        ...
        redirect("field_worker/dps_collection");
    }
    ...
    public function dps_collection_list(){
        ...
        $user_id = $this->session->userdata('user_id');
        $data['dps_col'] = $this->dam->dps_collection_list_worker($user_id);
        $this->load->view('field_worker/dps_collection_list', $data);
    }
    ...
    public function edit_dps_collection($id) {
        ...
        $data['title'] = "আপডেট করুন";
        $this->load->view('field_worker/edit_dps_collection', $data);
    }
    public function update_dps_collection(){
        ...
        redirect("field_worker/dps_collection_list");
...
//        $this->load->view('field_worker/dps_report', $data);
//    }
//
...
//        $data['title'] = "ডিপিএস রিপোর্ট";
//        $this->load->view('field_worker/dps_report_list', $data);
//    }
    //End DPS Report
...
//        $this->load->view('field_worker/fdr_interest', $data);
//    }
    ...
    public function interest_generate($id){
        ...
        $this->load->model('add_member_model', 'amm');
        $data['member'] = $this->amm->get_member();
        $this->load->view('field_worker/interest_generate', $data);
    }
    ...
    function save_interest_generate(){
        ...
        redirect("field_worker/fdr_interest");
    }
    ...
    public function fdr_interest_list(){
        ...
        $this->load->view('field_worker/fdr_interest_list', $data);
    }
